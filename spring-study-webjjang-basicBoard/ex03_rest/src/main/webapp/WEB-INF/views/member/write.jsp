...
<script>
  $( function() {
	...
	$("#idCheckBtn").click(function(){
		...
		window.open("idCheck.do","idCheck", "width=400, height=400, top=100, left=400");
	});
	...
	<div class="container">
		...
		<form action="write.do" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="id">아이디 </label><button type="button" id="idCheckBtn" class="btn btn-default">아이디 중복체크</button>
				 <input type="text"class="form-control" id="id" name="id" readonly="readonly" placeholder="아이디 중복체크를 이용하세요.">
			</div>
