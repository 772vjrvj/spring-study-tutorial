	...
	<h4>새글 추가하기</h4><br>
		<form action="noticeBoardInsert.do" method="post">
			...
			<table >
				...
				<tr>
					<th>아이디</th>
					<td colspan="2">${loginId}</td>
				</tr>

				<tr>
					<th>제목</th>
					<td colspan="2"><input type="text"name="title" style="text-align: center;width: 600px;" required="required" autocomplete="off"  /></td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="2"><textarea class="form-control" rows="10" cols="63" name="content"required="required" autocomplete="off"></textarea></td>
				</tr>
				<tr>
					<td colspan="3" style="text-align: right;">
						<input class="btn btn-default btn-xs" type="submit" value="글추가"/>
