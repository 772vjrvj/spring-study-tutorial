...
public class HcPageMaker {
	...
	private int pageGroup;        // 현재 화면에 보이는 endPage 번호
	
	private boolean prev;       // 페이징 이전 버튼 활성화 여부
	private boolean next;       // 페이징 다음 버튼 활서화 여부
	
	
	private HcCriteria cri;       // 앞서 생성한 Criteria를 주입받는다.
	...
	public HcCriteria getCri() {
		return cri;
	}

	public void setCri(HcCriteria cri) {
		this.cri = cri;
	}
